    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        ...
                        break;
                    case 1:
                        startActivity(new Intent(tl_mesaj.this, tl_profil.class));
                        Intent intent = new Intent(tl_mesaj.this, tl_profil.class);
        ...
        cikis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(tl_mesaj.this, Hyphen.class));
            }
        });
        anasayfa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(tl_mesaj.this,takimlideri_paneli.class));
            }
        });
    }
}
